...
for dig in range(start_year, end_year + 1):
    ...
    elif uniq_digit2 != uniq_digit1 and uniq_digit2 != uniq_digit3 and uniq_digit2 != uniq_digit4:
        new_year.append(uniq_digit2)
    elif uniq_digit3 != uniq_digit2 and uniq_digit3 != uniq_digit1 and uniq_digit3 != uniq_digit4:
        new_year.append(uniq_digit3)
    elif uniq_digit4 != uniq_digit1 and uniq_digit4 != uniq_digit2 and uniq_digit4 != uniq_digit3:
